 ...
 * of a constructed {@link TachyonServer}.
 */
final class ServerAnnotationRegistrationContext implements AnnotationRegistrationContext {
    ...
    ServerAnnotationRegistrationContext(Tools tools, Resources resources, Prompts prompts, Completions completions) {
        this.tools = tools;
