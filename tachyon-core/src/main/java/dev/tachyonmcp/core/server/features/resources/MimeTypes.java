 ...
 * unknown extensions. {@link #isText(String)} reads the {@code isText} column for a known MIME
...
public final class MimeTypes {
    ...
    public static String guess(String fileName) {
        return DEFAULTS.getOrDefault(extensionOf(fileName), DEFAULT_MIME_TYPE);
    }
