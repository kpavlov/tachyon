...
class NettyServerThreadingTest {
    ...
    void eventLoopsAreOnPlatformThreadsAndToolHandlerOnVirtualThread() throws Exception {
        ...
        try (McpServer server = TachyonMcpServer.builder()
            ...
            Thread workerThread = netty.eventLoopGroup.next().submit(probe).get(5, TimeUnit.SECONDS);
            ...
            Thread toolThread = handlerThread.get(5, TimeUnit.SECONDS);
            assertThat(toolThread.isVirtual())
