...
/**
 * Step: register features (tools, resources, prompts, tasks).
 * Call capabilities methods to go back, or session/networks methods to transition onward.
 */
public final class FeatureStep {

    final BuilderState state;

    FeatureStep(BuilderState state) {
        this.state = state;
    }
    ...
    public FeatureStep jsonSchemaValidator(JsonSchemaValidator validator) {
        state.jsonSchemaValidator = validator;
        return this;
    }
