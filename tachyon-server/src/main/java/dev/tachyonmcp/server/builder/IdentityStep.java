...
/**
 * First step: configure server identity (name, version, description, website URL).
 * Call {@link #build()} to finish with defaults, or any configuration method to transition
 * to the next step.
 */
public final class IdentityStep {
    ...
    public IdentityStep name(String name) {
        state.name = name;
        return this;
    }

    public IdentityStep version(String version) {
        state.version = version;
        return this;
    }

    public IdentityStep description(String description) {
        state.description = description;
        return this;
    }

    public IdentityStep websiteUrl(String websiteUrl) {
    ...
    public CapabilitiesStep toolsEnabled(boolean listChanged) {
        ...
        return new CapabilitiesStep(state);
    }
    ...
    public FeatureStep tool(ToolHandler handler) {
