 ...
 * {@code META-INF/services/dev.tachyonmcp.protocol.api.json.spi.JsonDocumentFactory} and/or
 * {@code META-INF/services/dev.tachyonmcp.protocol.api.json.spi.JsonSchemaFactory} to make it
