 ...
 * {@code META-INF/services/dev.tachyonmcp.json.spi.JsonDocumentFactory} and/or
 * {@code META-INF/services/dev.tachyonmcp.json.spi.JsonSchemaFactory} to make it
 * discoverable by {@link JsonDocument#from(Object, Class)} and
 * {@link JsonSchema#from(Object, Class)}.
 */
@NullMarked
package dev.tachyonmcp.json.spi;
