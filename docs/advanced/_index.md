...
Internal notes on transport behaviour, kept in the repository for contributors. They are not
...
The behaviour a server author can rely on is documented under
